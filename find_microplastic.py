...
for image_path in images_list:
    ...
    cv2.imwrite(os.path.join(output_folder, "$.png"), image)
    try:
        os.remove(os.path.join(output_folder, "result_"+filename))
    except OSError:
        pass
    os.rename(os.path.join(output_folder, "$.png"), os.path.join(output_folder, "result_"+filename))
